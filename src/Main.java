    ...
    */
    ...
    public static class Person {
        ...
        private int damage = 0;
         ...
         protected Person(String name_, int health_, int protection_) {
            name = name_;
        ...
        void takeDamage(Integer damage) throws Exception {
            ...
            if (damage > health) {
                ...
                if (health == 0) throw new PersonDead("Person is dead");
            }
        }
    ...
    public static class Mage extends Person {
        ...
        void takeDamage(Integer damage) throws Exception, PersonDead {
            health = health - (damage - protection - health % 10);
            if (health <= 0) {
                throw new PersonDead("Mage is dead");
            }
        ...
        public static class Archer extends Person {
            ...
            void takeDamage(Integer damage) throws Exception, PersonDead{
                ...
                if (health <= 0) {
                    throw new PersonDead("Archer is dead");
                }
            }
